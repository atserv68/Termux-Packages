...
| **biome2** | 2.5.11 | A toolchain for web projects, aimed to provide functionalities to maintain them. Biome offers formatter and linter, usable via CLI and LSP | https://biomejs.dev/ |
...
| **jfrog-cli** | 2.122.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **mycli** | 2.18.5-1 | CLI for MySQL/MariaDB with auto-completion and syntax highlighting | https://mycli.net |
...
| **watchexec** | 2.7.0 | Executes commands in response to file modifications | https://github.com/watchexec/watchexec |
