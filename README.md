...
| **golangci-lint** | 2.13.1 | Fast linters runner for Go, aggregating many Go linters into one tool | https://golangci-lint.run/ |
...
| **uv** | 0.12.6 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
