...
| **lux-cli** | 0.42.0 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **oma** | 1.27.7 | oma is an attempt at reworking APT's interface | https://aosc.io/oma |
...
| **simdjson** | 4.6.8 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
