...
| **awscli** | 2.36.34 | Universal Command Line Interface for Amazon Web Services | https://aws.amazon.com/cli |
...
| **flyctl** | 0.4.95 | Command line tools for fly.io services | https://fly.io |
...
| **lux-cli** | 0.43.1 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **ty** | 0.0.76 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
...
| **uv** | 0.12.7 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **wasi-libc** | 34 | Libc for WebAssembly programs built on top of WASI system calls | https://wasi.dev/ |
