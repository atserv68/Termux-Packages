...
| **cloudflared** | 2026.9.1 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **doctl** | 1.173.0 | The official command line interface for the DigitalOcean API | https://github.com/digitalocean/doctl |
...
| **gradle** | 1:9.7.1-1 | Powerful build system for the JVM | https://gradle.org/ |
...
| **ty** | 0.0.83 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
...
| **wakatime-cli** | 2.26.6 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
