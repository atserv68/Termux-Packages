...
| **7zip** | 26.03 | 7-Zip file archiver with a high compression ratio | https://www.7-zip.org |
...
| **aapt** | 16.0.0.4-2 | Android Asset Packaging Tool | https://github.com/termux/android-build-tools |
| **aapt2** | 16.0.0.4-2 | AAPT2 (Android Asset Packaging Tool) | https://github.com/termux/android-build-tools |
...
| **aidl** | 16.0.0.4-2 | Android Interface Definition Language (AIDL) | https://github.com/termux/android-build-tools |
| **air** | 1.67.4 | Live reload for Go apps - rebuilds and restarts your binary on file change | https://github.com/air-verse/air |
...
| **ani-cli** | 5.1 | A cli to browse and watch anime | https://github.com/pystardust/ani-cli |
...
| **ant** | 1.10.18 | Java based build tool like make | https://ant.apache.org/ |
...
| **aom-tools** | 3.15.1 | Command-line tools using AOMedia library | https://aomedia.org/ |
...
| **arturo** | 0.10.0-1 | Simple, expressive & portable programming language for efficient scripting | https://arturo-lang.io |
...
| **asciidoctor** | 2.0.26-1 | An implementation of AsciiDoc in Ruby | https://asciidoctor.org/ |
...
| **aspell-en** | 1:2026.02.25 | English dictionary for aspell | http://aspell.net/ |
...
| **automake** | 1.19 | Tool for automatically generating Makefile.in files | https://www.gnu.org/software/automake/ |
...
| **beanshell** | 3.0.0b1 | Small, free, embeddable, source level Java interpreter with object based scripting language features written in Java | https://github.com/beanshell/beanshell |
| **bear** | 4.2.2 | Bear is a tool that generates a compilation database for clang tooling. | https://github.com/rizsotto/Bear |
| **bed** | 0.2.8 | Binary editor written in GO | https://github.com/itchyny/bed |
| **bftpd** | 6.7 | Small, easy-to-configure FTP server | https://bftpd.sourceforge.net/ |
...
| **binaryen** | 133 | Binaryen is a compiler and toolchain infrastructure library for WebAssembly | https://github.com/WebAssembly/binaryen |
...
| **black-hole-solver** | 1.14.0-1 | Black Hole Solver is a solitaire solver for 'Golf', 'Black Hole' and 'All in a Row'. | https://fc-solve.shlomifish.org/ |
...
| **brook** | 20270101 | A cross-platform strong encryption and not detectable proxy. Zero-Configuration. | https://github.com/txthinking/brook |
| **broot** | 1.60.1 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **ca-certificates** | 1:2026.08.13 | Common CA certificates | https://curl.se/docs/caextract.html |
| **ca-certificates-java** | 1:2026.08.13 | Common CA certificates (java keystore format) | https://curl.se/docs/caextract.html |
...
| **cargo-binstall** | 1.23.0 | Tool to fetch and install precompiled musl-based static binaries from the Rust ecosystem | https://github.com/cargo-bins/cargo-binstall |
...
| **cavif** | 1.8.0 | AVIF image creator in pure Rust | https://lib.rs/cavif |
...
| **ccache** | 4.14 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **chafa** | 1.18.3 | Image-to-text converter supporting a wide range of symbols, etc. | https://hpjansson.org/chafa/ |
| **chafa-static** | 1.18.3 | Static libraries for chafa | https://hpjansson.org/chafa/ |
...
| **chrony** | 4.9 | chrony is an implementation of the Network Time Protocol (NTP) | https://chrony-project.org/ |
...
| **cppcheck** | 2.22.0 | tool for static C/C++ code analysis | https://github.com/danmar/cppcheck |
...
| **csh** | 20110502-2 | C Shell with process control from 3BSD | https://packages.debian.org/sid/csh |
...
| **ctranslate2** | 4.8.2 | A fast inference engine for Transformer models | https://github.com/OpenNMT/CTranslate2 |
...
| **debootstrap** | 1.0.145 | Bootstrap a basic Debian system | https://wiki.debian.org/Debootstrap |
| **delve** | 1.27.2 | A debugger for the Go programming language | https://github.com/go-delve/delve |
| **deno** | 1:2.9.7 | A modern runtime for JavaScript and TypeScript | https://deno.land/ |
...
| **dnglab** | 0.8.0 | Camera RAW to DNG file format converter | https://github.com/dnglab/dnglab |
...
| **dnscontrol** | 5.2.0 | Infrastructure as code for DNS! | https://dnscontrol.org/ |
...
| **docker-compose** | 5.5.1 | Compose is a tool for defining and running multi-container Docker applications. | https://github.com/docker/compose |
...
| **dua** | 2.45.0 | View disk space usage and delete unwanted data, fast | https://github.com/Byron/dua-cli |
...
| **dwarves** | 1.32 | Pahole and other DWARF utils | https://git.kernel.org/cgit/devel/pahole/pahole.git/ |
...
| **erlang** | 29.1.1 | General-purpose concurrent functional programming language | https://www.erlang.org/ |
| **erlang-doc** | 29.1.1 | Erlang HTML documentation | https://www.erlang.org/ |
...
| **execline** | 2.9.9.2-1 | A small scripting language, to be used with an exec chain | https://skarnet.org/software/execline/ |
| **execline-static** | 2.9.9.2-1 | Static libraries for execline | https://skarnet.org/software/execline/ |
...
| **fastfetch** | 2.69.0 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **faust** | 2.88.0 | A functional programming language for signal processing and sound synthesis | https://github.com/grame-cncm/faust |
| **faust-static** | 2.88.0 | Static libraries for faust | https://github.com/grame-cncm/faust |
| **faustlibraries** | 2.88.0 | Faust DSP libraries | https://github.com/grame-cncm/faust |
...
| **fetchmail** | 6.6.8 | A remote-mail retrieval utility | https://www.fetchmail.info/ |
| **fetchmailconf** | 6.6.8 | A GUI configurator for generating fetchmail configuration files | https://www.fetchmail.info/ |
| **fff** | 2.2 | A simple file manager written in bash | https://github.com/dylanaraps/fff |
| **ffmpeg** | 8.1.3 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **flyctl** | 0.4.108 | Command line tools for fly.io services | https://fly.io |
| **fm** | 1.2.0 | A terminal based file manager | https://github.com/knipferrc/fm |
| **fmt** | 1:11.2.0-1 | Open-source formatting library for C++ | https://fmt.dev/latest/index.html |
...
| **foundry** | 1.8.3-1 | A blazing fast, portable and modular toolkit for Ethereum application development | https://github.com/foundry-rs/foundry |
...
| **gatling** | 0.16-3 | A high performance http, ftp and smb server | https://www.fefe.de/gatling/ |
...
| **gdb** | 18.1 | The standard GNU Debugger that runs on many Unix-like systems and works for many programming languages | https://www.gnu.org/software/gdb/ |
...
| **gdbserver** | 18.1 | The gdbserver program | https://www.gnu.org/software/gdb/ |
...
| **geth** | 1.17.6 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.17.6 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **git-lfs** | 3.8.0 | Git extension for versioning large files | https://git-lfs.github.com/ |
...
| **gopass** | 1.17.3 | The slightly more awesome standard unix password manager for teams | https://github.com/gopasspw/gopass |
| **gopher** | 3.0.19 | University of Minnesota gopher | gopher://gopher.quux.org/1/devel/gopher |
| **gopls** | 0.23.0 | The official Go language server | https://github.com/golang/tools |
| **goreleaser** | 2.18.2 | Deliver Go binaries as fast and easily as possible | https://goreleaser.com |
...
| **gotestsum** | 1.13.0 | 'go test' runner with output optimized for humans, JUnit XML for CI integration, and a summary of the test results | https://github.com/gotestyourself/gotestsum |
...
| **graphviz** | 16.1.0 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 16.1.0 | Static libraries for graphviz | https://www.graphviz.org/ |
| **greed** | 5.2 | Game where you try to eat as much as possible of the board before munching yourself into a corner | http://www.catb.org/~esr/greed/ |
...
| **groff** | 1.24.1 | typesetting system that reads plain text mixed with formatting commands and produces formatted output | https://www.gnu.org/software/groff/ |
| **gron** | 0.7.1-4 | Transforms JSON into discrete assignments | https://github.com/tomnomnom/gron |
| **groonga** | 16.1.1 | An embeddable fulltext search engine | https://github.com/groonga/groonga/ |
...
| **gsf-tools** | 1.14.59 | Command-line tools for libgsf | https://gitlab.gnome.org/GNOME/libgsf |
...
| **gst-libav** | 1.28.7 | GStreamer Libav plug-in contains one plugin with a set of elements using the Libav library code | https://gstreamer.freedesktop.org/modules/gst-libav.html |
| **gst-plugins-bad** | 1.28.7 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-base** | 1.28.7 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-good** | 1.28.7 | GStreamer Good Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-ugly** | 1.28.7 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.28.7 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.28.7 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
| **gtrash** | 0.0.6-1 | A featureful trash CLI manager, alternative to rm and trash-cli | https://github.com/umlx5h/gtrash |
...
| **haproxy** | 3.4.5 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
| **harfbuzz** | 14.5.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 14.5.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 14.5.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **helm** | 4.3.0 | Helm helps you manage Kubernetes applications | https://helm.sh |
...
| **hstr** | 3.2 | Shell history suggest box for bash and zsh | https://github.com/dvorka/hstr |
...
| **httrack** | 3.50.4 | It allows you to download a World Wide Web site from the Internet | http://www.httrack.com |
| **httrack-data** | 3.50.4 | Platform-independent data for httrack | http://www.httrack.com |
| **httrack-static** | 3.50.4 | Static libraries for httrack | http://www.httrack.com |
...
| **hurl** | 8.0.1 | Command line tool that runs and tests HTTP requests defined in a plain text format | https://hurl.dev |
| **hut** | 0.8.0-1 | A CLI tool for sr.ht | https://git.sr.ht/~xenrox/hut |
| **hwdata** | 0.411 | Database of hardware identification and configuration data | https://github.com/vcrhonek/hwdata |
...
| **iconv** | 1.19 | Utility converting between different character encodings | https://www.gnu.org/software/libiconv/ |
...
| **jackett** | 0.24.2627 | API Support for your favorite torrent trackers | https://github.com/jackett/jackett |
...
| **jump** | 0.69.0 | Jump helps you navigate in shell faster by learning your habits | https://github.com/gsamokovarov/jump |
...
| **jython** | 2.7.5b1 | Python for the Java Platform | https://www.jython.org/ |
| **k2pdfopt** | 2.55-6 | A tool that optimizes PDF files for viewing on mobile readers | https://www.willus.com/k2pdfopt/ |
| **k6** | 2.3.0 | Modern load-testing tool for developers and testers | https://k6.io |
...
| **kew** | 4.3.6 | Music for the Shell | https://kewplayer.com |
| **keybase** | 6.6.3 | Key directory that maps social media identities to encryption keys | https://keybase.io |
| **keychain** | 3.0.5 | Keychain manager for ssh-agent and gpg-agent | https://kernel-seeds.org/projects/keychain/ |
...
| **knot-utils** | 3.5.5 | Knot DNS utilities | https://www.knot-dns.cz/ |
...
| **less** | 710 | Terminal pager program used to view the contents of a text file one screen at a time | https://www.greenwoodsoftware.com/less/ |
...
| **lfortran** | 0.66.0 | A modern open-source interactive Fortran compiler | https://lfortran.org/ |
| **lfortran-static** | 0.66.0 | Static libraries for lfortran | https://lfortran.org/ |
| **lftp** | 4.9.3 | FTP/HTTP client and file transfer program | https://lftp.tech/ |
| **lftp-static** | 4.9.3 | Static libraries for lftp | https://lftp.tech/ |
| **lgogdownloader** | 3.19 | Open source downloader to GOG.com for Linux users using the same API as the official GOGDownloader | https://sites.google.com/site/gogdownloader/ |
...
| **libabw** | 0.1.4 | a library that parses the file format of AbiWord documents | https://wiki.documentfoundation.org/DLP/Libraries/libabw |
| **libabw-static** | 0.1.4 | Static libraries for libabw | https://wiki.documentfoundation.org/DLP/Libraries/libabw |
...
| **libandroid-stub** | 30 | Stub libandroid.so for non-Android certified environment | https://android.googlesource.com/platform/frameworks/base/+/main/native/android |
...
| **libaom** | 3.15.1 | AV1 Video Codec Library | https://aomedia.org/ |
| **libaom-static** | 3.15.1 | Static libraries for libaom | https://aomedia.org/ |
...
| **libbcprov-java** | 1.86 | A lightweight cryptography API for Java | https://www.bouncycastle.org/java.html |
| **libblkid** | 2.42.1-4 | Block device identification library | https://en.wikipedia.org/wiki/Util-linux |
| **libblocksruntime** | 1:6.4.0 | LLVM Blocks runtime library | https://github.com/swiftlang/swift-corelibs-libdispatch |
...
| **libbsd** | 0.12.2 | utility functions from BSD systems | https://libbsd.freedesktop.org |
| **libbsd-static** | 0.12.2 | Static libraries for libbsd | https://libbsd.freedesktop.org |
...
| **libcap** | 2.78 | POSIX 1003.1e capabilities | https://sites.google.com/site/fullycapable/ |
| **libcap-ng** | 2:0.9.6 | Library making programming with POSIX capabilities easier than traditional libcap | https://people.redhat.com/sgrubb/libcap-ng/ |
| **libcap-ng-static** | 2:0.9.6 | Static libraries for libcap-ng | https://people.redhat.com/sgrubb/libcap-ng/ |
| **libcap-static** | 2.78 | Static libraries for libcap | https://sites.google.com/site/fullycapable/ |
...
| **libcdr** | 0.1.9 | CorelDraw file format importer library for LibreOffice | https://wiki.documentfoundation.org/DLP/Libraries/libcdr |
...
| **libcurl** | 8.22.0 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.22.0 | Static libraries for libcurl | https://curl.se/ |
...
| **libdispatch** | 1:6.4.0 | The libdispatch project, for concurrency on multicore hardware | https://github.com/swiftlang/swift-corelibs-libdispatch |
...
| **libdvbcsa** | 1.1.0-4 | An implementation of the DVB Common Scrambling Algorithm - DVB/CSA - with encryption and decryption capabilities | https://www.videolan.org/developers/libdvbcsa.html |
| **libdvbcsa-static** | 1.1.0-4 | Static libraries for libdvbcsa | https://www.videolan.org/developers/libdvbcsa.html |
...
| **libdw** | 0.196 | Library to read DWARF information | https://sourceware.org/elfutils/ |
| **libdw-static** | 0.196 | Static library to read DWARF information | https://sourceware.org/elfutils/ |
| **libdwarf** | 2.3.3 | Library for handling DWARF Debugging Information Format | https://www.prevanders.net/dwarf.html |
| **libdwarf-static** | 2.3.3 | Static libraries for libdwarf | https://www.prevanders.net/dwarf.html |
| **libe-book** | 0.1.4 | Library for import of reflowable e-book formats. | https://sourceforge.net/projects/libebook/ |
| **libe-book-static** | 0.1.4 | Static libraries for libe-book | https://sourceforge.net/projects/libebook/ |
...
| **libelf** | 0.196 | ELF object file access library | https://sourceware.org/elfutils/ |
| **libelf-static** | 0.196 | Static libraries for libelf | https://sourceware.org/elfutils/ |
...
| **libffi** | 3.8.0 | Library providing a portable, high level programming interface to various calling conventions | https://sourceware.org/libffi/ |
| **libffi-static** | 3.8.0 | Static libraries for libffi | https://sourceware.org/libffi/ |
...
| **libgeos** | 3.15.0 | Geometry Engine, C++ port of the Java Topology Suite | https://geos.osgeo.org/ |
...
| **libgrpc** | 1.84.0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libgsf** | 1.14.59 | The G Structured File Library | https://gitlab.gnome.org/GNOME/libgsf |
| **libgsf-static** | 1.14.59 | Static libraries for libgsf | https://gitlab.gnome.org/GNOME/libgsf |
...
| **libiniparser** | 4.3.0 | Offers parsing of ini files from the C level | https://github.com/ndevilla/iniparser |
| **libiniparser-static** | 4.3.0 | Static libraries for libiniparser | https://github.com/ndevilla/iniparser |
...
| **libiptcdata** | 1.0.5 | a C library for manipulating the IPTC metadata stored within multimedia files | https://libiptcdata.sourceforge.net/ |
| **libiptcdata-static** | 1.0.5 | Static libraries for libiptcdata | https://libiptcdata.sourceforge.net/ |
...
| **libjanet** | 1.42.1 | Development library for Janet | https://janet-lang.org |
| **libjanet-static** | 1.42.1 | Static libraries for libjanet | https://janet-lang.org |
...
| **libjxl** | 0.12.0-1 | JPEG XL image format reference implementation | https://jpegxl.info/ |
| **libjxl-progs** | 0.12.0-1 | Programs for manipulating JPEG XL files | https://jpegxl.info/ |
...
| **libknot** | 3.5.5 | Knot DNS libraries | https://www.knot-dns.cz/ |
| **libknot-static** | 3.5.5 | Static libraries for libknot | https://www.knot-dns.cz/ |
...
| **liblangtag** | 0.6.8 | interface library to access/deal with tags for identifying languages | https://gitlab.com/tagoh/liblangtag |
| **liblangtag-static** | 0.6.8 | Static libraries for liblangtag | https://gitlab.com/tagoh/liblangtag |
...
| **libliquid-dsp** | 1.8.2 | Software-defined radio digital signal processing library | https://liquidsdr.org/ |
| **libliquid-dsp-static** | 1.8.2 | Static libraries for libliquid-dsp | https://liquidsdr.org/ |
...
| **liblmdb** | 1.0.2 | LMDB implements a simplified variant of the BerkeleyDB (BDB) API | https://symas.com/lmdb/ |
| **liblmdb-static** | 1.0.2 | Static libraries for liblmdb | https://symas.com/lmdb/ |
...
| **liblzma** | 5.8.4 | XZ-format compression library | https://tukaani.org/xz/ |
...
| **libmd-static** | 1.2.0 | Static libraries for libmd | https://www.hadrons.org/software/libmd/ |
...
| **libmpg123** | 1.33.7 | Fast console MPEG Audio Player and decoder library | https://mpg123.org/ |
| **libmpg123-static** | 1.33.7 | Static libraries for libmpg123 | https://mpg123.org/ |
...
| **libnss** | 3.130 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libopencc** | 1.4.2 | An opensource project for conversions between Traditional Chinese, Simplified Chinese and Japanese Kanji (Shinjitai) | https://github.com/BYVoid/OpenCC |
...
| **libopusenc** | 0.3 | High-level API for encoding .opus files | https://github.com/xiph/libopusenc |
| **libopusenc-static** | 0.3 | Static libraries for libopusenc | https://github.com/xiph/libopusenc |
| **liborc** | 0.4.44 | Library of Optimized Inner Loops Runtime Compiler | https://gstreamer.freedesktop.org/projects/orc.html |
...
| **libosmpbf** | 1.8.0 | osmpbf is a Java/C library to read and write OpenStreetMap PBF files | https://github.com/openstreetmap/OSM-binary/ |
| **libosmpbf-static** | 1.8.0 | Static libraries for libosmpbf | https://github.com/openstreetmap/OSM-binary/ |
...
| **libowfat** | 0.34 | GPL reimplementation of libdjb | http://www.fefe.de/libowfat/ |
| **libp11** | 0.4.21 | PKCS#11 wrapper library | https://github.com/OpenSC/libp11 |
...
| **libpagmo** | 2.20.0 | Scientific library for massively parallel optimization | https://esa.github.io/pagmo2/index.html |
| **libpangomm-1.4** | 2.46.5 | A C++ API for Pango | https://www.gtkmm.org/ |
| **libpangomm-2.48** | 2.58.0 | A C++ API for Pango | https://www.gtkmm.org/ |
...
| **libpcsclite** | 2.5.2 | Middleware to access a smart card using SCard API (PC/SC). | https://pcsclite.apdu.fr/ |
...
| **libpoco** | 1.15.4 | A comprehensive set of C++ libraries that cover all modern-day programming needs | https://pocoproject.org/ |
...
| **libprotozero** | 1.8.2 | Minimalistic protocol buffer decoder and encoder in C++ | https://github.com/mapbox/protozero |
...
| **libpwquality** | 1.4.5 | Library for password quality checking and generating random passwords | https://github.com/libpwquality/libpwquality |
...
| **librist** | 0.2.20 | Library to add the RIST protocol to applications | https://code.videolan.org/rist/librist |
...
| **librusty-v8** | 1:2.9.7 | High quality Rust bindings to V8's C++ API | https://deno.land/ |
...
| **libsecret** | 0.21.8.2 | A GObject-based library for accessing the Secret Service API | https://gitlab.gnome.org/GNOME/libsecret |
...
| **libsnappy** | 1.3.1 | A compression/decompression library | https://github.com/google/snappy |
...
| **libstemmer** | 3.1.1 | Snowball compiler and stemming algorithms | https://snowballstem.org/ |
| **libstemmer-static** | 3.1.1 | Static libraries for libstemmer | https://snowballstem.org/ |
...
| **libsynctex** | 1:2026.0-2 | Library for synchronization between TeX files and resulting file | https://www.tug.org/texlive/ |
...
| **libtdb** | 1.4.15-1 | A trivial database system | https://tdb.samba.org/ |
...
| **libtsduck** | 3.45.4798 | An extensible toolkit for MPEG transport streams | https://tsduck.io/ |
| **libtsduck-static** | 3.45.4798 | Static libraries for libtsduck | https://tsduck.io/ |
...
| **libunqlite** | 1.2.1 | Transactional embedded database engine | https://unqlite.org/ |
| **liburcu** | 0.15.7 | LGPLv2.1 userspace RCU (read-copy-update) library | https://liburcu.org/ |
| **liburcu-static** | 0.15.7 | Static libraries for liburcu | https://liburcu.org/ |
...
| **libuv** | 1.53.0 | Support library with a focus on asynchronous I/O | https://libuv.org |
| **libuv-static** | 1.53.0 | Static libraries for libuv | https://libuv.org |
...
| **libvidstab** | 1.1.2 | video stabilization library | https://github.com/georgmartius/vid.stab |
| **libvigra** | 1.12.4-1 | Computer vision library | https://ukoethe.github.io/vigra/ |
| **libvips** | 8.18.7 | A fast image processing library with low memory needs | https://libvips.github.io/libvips/ |
...
| **libvpx** | 1:1.17.0 | VP8 & VP9 Codec SDK | https://www.webmproject.org |
| **libvpx-static** | 1:1.17.0 | Static libraries for libvpx | https://www.webmproject.org |
...
| **libxmp** | 4.7.3 | Extended Module Player C Library that renders tracker and module music (MOD, S3M, IT, XM etc.) | https://github.com/libxmp/libxmp |
| **libxmp-static** | 4.7.3 | Static libraries for libxmp | https://github.com/libxmp/libxmp |
...
| **libzim** | 9.8.2-1 | The ZIM library is the reference implementation for the ZIM file format. | https://openzim.org |
...
| **links** | 2.30 | Links is a text and graphics mode WWW browser | http://links.twibright.com |
...
| **litecli** | 1.17.1-2 | CLI for SQLite databases with auto-completion and syntax highlighting | https://litecli.com |
...
| **llbuild** | 6.4.0 | A low-level build system, used by the Swift Package Manager | https://github.com/swiftlang/swift-llbuild |
...
| **lnav** | 0.14.1 | An advanced log file viewer for the small-scale | https://lnav.org/ |
...
| **lowdown** | 3.2.1 | Markdown utilities and library (fork of hoedown -> sundown -> libsoldout) | https://kristaps.bsd.lv/lowdown |
| **lowdown-static** | 3.2.1 | Static libraries for lowdown | https://kristaps.bsd.lv/lowdown |
...
| **lynx** | 2.9.3 | The text web browser | http://lynx.browser.org/ |
...
| **mandoc** | 1.14.6-8 | Man page viewer from the mandoc toolset | https://mdocml.bsd.lv/ |
...
| **mdbook-plantuml** | 2.0.0 | mdBook preprocessor to render PlantUML code blocks as images in your book | https://github.com/sytsereitsma/mdbook-plantuml |
...
| **miller** | 6.22.0 | Like awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON | https://miller.readthedocs.io/ |
...
| **mise** | 2026.9.14 | dev tools, env vars, task runner | https://mise.jdx.dev/ |
...
| **mpd** | 0.24.15 | Music player daemon | https://www.musicpd.org |
...
| **mpg123** | 1.33.7 | Fast console MPEG Audio Player based on libmpg123 | https://mpg123.org/ |
| **mplayer** | 1.5-15 | The Movie Player | https://mplayerhq.hu/ |
| **mpv** | 0.41.0-3 | Command-line media player | https://mpv.io/ |
...
| **ms-gsl** | 5.0.1 | Guidelines Support Library | https://github.com/Microsoft/GSL |
...
| **mujs** | 1.3.10 | A lightweight Javascript interpreter designed for embedding in other software | https://mujs.com/ |
...
| **nchat** | 5.18.20-1 | TUI for Telegram and WhatsApp | https://github.com/d99kris/nchat |
...
| **ndk-multilib** | 30 | Multilib binaries for cross-compilation | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-static** | 30 | Install native static libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-stubs** | 30 | Install native stubs for shared libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-sysroot** | 30 | System header and library files from the Android NDK needed for compiling C programs | https://developer.android.com/tools/sdk/ndk/index.html |
| **ne** | 3.3.4-4 | Easy-to-use and powerful text editor | https://ne.di.unimi.it/ |
...
| **neovim-nightly** | 0.13.0~dev-1738+g521eddec7c-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **netcat-openbsd** | 1.238-1-2 | TCP/IP swiss army knife. OpenBSD variant. | https://packages.debian.org/sid/netcat-openbsd |
...
| **npm** | 11.20.0 | The package manager for JavaScript | https://docs.npmjs.com/cli/ |
...
| **openxr** | 1.1.63 | Open standard that provides a common set of APIs for developing XR applications | https://www.khronos.org/openxr/ |
...
| **orbiton** | 2.74.5 | Small, fast and limited text editor | https://roboticoverlords.org/orbiton/ |
...
| **oxfmt** | 1.85.0 | Oxc JavaScript formatter | https://oxc.rs/ |
...
| **pcscd** | 2.5.2 | Middleware to access a smart card using SCard API (PC/SC). (daemon side) | https://pcsclite.apdu.fr/ |
...
| **pikiwidb** | 3.5.6-3 | Redis-Compatible database developed by Qihoo's infrastructure team | https://github.com/OpenAtomFoundation/pikiwidb |
| **pikiwidb-static** | 3.5.6-3 | Static libraries for pikiwidb | https://github.com/OpenAtomFoundation/pikiwidb |
...
| **plantuml** | 1.2026.8 | Draws UML diagrams, using a simple and human readable text description | https://plantuml.com/ |
...
| **pnpm** | 12.7.0 | Fast, disk space efficient package manager for JavaScript | https://pnpm.io |
...
| **proot** | 5.1.107.95 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
...
| **ptex** | 2.5.4 | Per-Face Texture Mapping for Production Rendering | https://github.com/wdas/ptex |
| **ptex-static** | 2.5.4 | Static libraries for ptex | https://github.com/wdas/ptex |
...
| **python-rpds-py** | 2026.6.3 | Python bindings to Rust's persistent data structures (rpds) | https://github.com/crate-py/rpds |
| **python-ruff** | 0.16.9 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **ravencoin** | 4.8.0 | A peer-to-peer blockchain, handling the efficient creation and transfer of assets from one party to another | https://ravencoin.org/ |
...
| **re2c** | 4.6 | Lexer generator for C, C++ and Go. | https://re2c.org/ |
| **readline** | 8.3.6 | Library that allow users to edit command lines as they are typed in | https://tiswww.case.edu/php/chet/readline/rltop.html |
| **readline-static** | 8.3.6 | Static libraries for readline | https://tiswww.case.edu/php/chet/readline/rltop.html |
| **recode** | 3.7.16 | Charset converter tool and library | https://github.com/pinard/Recode |
| **recode-static** | 3.7.16 | Static libraries for recode | https://github.com/pinard/Recode |
| **recoll** | 1.44.2 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.44.2 | Python interface for Recoll | https://www.recoll.org/ |
...
| **redis** | 1:8.10.2 | In-memory data structure store used as a database, cache and message broker | https://redis.io/ |
| **redland** | 1.0.17-1 | Library that provides a high-level interface to RDF data | http://librdf.org/ |
| **remind** | 1:06.03.04 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rgbds** | 1.0.4 | Rednex Game Boy Development System - An assembly toolchain for the Nintendo Game Boy & Game Boy Color | https://rgbds.gbdev.io |
...
| **rizin** | 0.9.1-2 | UNIX-like reverse engineering framework and command-line toolset. | https://rizin.re |
...
| **rmw** | 0.10.0 | A command-line recycle bin utility (ReMove to Waste) | https://theimpossibleastronaut.com/rmw-website/ |
...
| **rust-docs** | 1.98.1-1 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.98.1-1 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.98.1-1 | Component files for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.98.1-1 | Component files for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.98.1-1 | Component files for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.98.1-1 | Component files for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.98.1-1 | Component files for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.98.1-1 | Component files for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip3** | 1.98.1-1 | Component files for target wasm32-wasip3 | https://www.rust-lang.org/ |
| **rust-std-wasm32v1-none** | 1.98.1-1 | Component files for target wasm32v1-none | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.98.1-1 | Component files for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.98.1-1 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.98.1-1 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **sabnzbd** | 5.1.3 | Fully automated Usenet Binary Downloader | https://sabnzbd.org/ |
| **samba** | 4.24.6 | SMB/CIFS fileserver | https://www.samba.org/ |
...
| **sbcl** | 2.6.8 | A high performance Common Lisp compiler | http://www.sbcl.org/ |
...
| **sea-orm-cli** | 2.0.3 | Command line utility for SeaORM, an async & dynamic ORM for Rust | https://github.com/SeaQL/sea-orm |
...
| **seanime** | 3.10.3 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **shfmt** | 3.14.1 | A shell parser and formatter | https://github.com/mvdan/sh |
...
| **soju** | 0.11.0 | A user-friendly IRC bouncer | https://codeberg.org/emersion/soju |
| **solidity** | 0.8.37 | An Ethereum smart contract-oriented language | https://www.soliditylang.org/ |
| **sonarr** | 4.0.20.3014-1 | A PVR for Usenet and BitTorrent users (server) | https://sonarr.tv |
...
| **sourcekit-lsp** | 6.4.0 | Language Server Protocol implementation for Swift and C-based languages | https://swift.org/ |
...
| **spatialite-tools** | 5.1.0a | Collection of tools supporting SpatiaLite | https://www.gaia-gis.it/fossil/spatialite-tools |
...
| **speedtest-go** | 1.8.3 | Command line interface to test internet speed using speedtest.net | https://github.com/showwin/speedtest-go/ |
...
| **sqlc** | 1.31.1-1 | Generate type-safe code from SQL | https://sqlc.dev |
| **sqlcipher** | 4.19.0 | SQLCipher is an SQLite extension that provides 256 bit AES encryption of database files | https://github.com/sqlcipher/sqlcipher |
...
| **sslscan** | 2.2.3 | Utility to discover supported cipher suites on SSL/TLS enabled servers | https://github.com/rbsec/sslscan |
| **sssnake** | 0.4.0 | cli snake game that plays itself | https://github.com/AngelJumbo/sssnake |
...
| **stemwords** | 3.1.1 | A command-line tool which uses libstemmer | https://snowballstem.org/ |
| **step-cli** | 0.31.0 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **storj-uplink** | 1.163.6 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **suitesparse** | 2:7.14.1 | A Suite of Sparse matrix packages. | https://github.com/DrTimothyAldenDavis/SuiteSparse |
| **suitesparse-static** | 2:7.14.1 | Static libraries for suitesparse | https://github.com/DrTimothyAldenDavis/SuiteSparse |
| **sun** | 1.0.0-3 | A very simple note taking cli app | https://stand-up-notes.org |
| **sundials** | 2:7.9.0 | SUite of Nonlinear and DIfferential/ALgebraic equation Solvers. | https://computing.llnl.gov/projects/sundials |
| **sundials-static** | 2:7.9.0 | Static libraries for sundials | https://computing.llnl.gov/projects/sundials |
| **supercollider** | 3.14.1-1 | A platform for audio synthesis and algorithmic composition | http://supercollider.github.io/ |
| **superhtml** | 0.7.0 | A HTML language server and templating engine formatter/linter | https://github.com/kristoff-it/superhtml |
...
| **swift-runtime-x86-64** | 6.4.0 | Swift runtime libraries for Android x86_64 | https://swift.org/ |
| **swift-sdk-aarch64** | 6.4.0 | Swift SDK for Android AArch64 | https://swift.org/ |
| **swift-sdk-arm** | 6.4.0 | Swift SDK for Android armv7 | https://swift.org/ |
| **swift-sdk-x86-64** | 6.4.0 | Swift SDK for Android x86_64 | https://swift.org/ |
...
| **syncthing** | 2.1.5 | Decentralized file synchronization | https://syncthing.net/ |
| **sysprop** | 16.0.0.4-2 | Android sysprop generators | https://github.com/termux/android-build-tools |
...
| **taglib** | 2.3.2 | A Library for reading and editing the meta-data of several popular audio formats. | http://taglib.github.io/ |
...
| **tdb-tools** | 1.4.15-1 | Tools for TDB | https://tdb.samba.org/ |
| **tdl** | 0.20.4 | Telegram downloader/tools written in Golang | https://docs.iyear.me/tdl/ |
| **tea** | 0.16.0 | The official CLI for Gitea | https://gitea.com/gitea/tea |
| **tealdeer** | 1.9.0 | A very fast implementation of tldr in Rust | https://tealdeer-rs.github.io/tealdeer/ |
...
| **television** | 0.15.9 | A very fast, portable and hackable fuzzy finder | https://github.com/alexpasmantier/television |
...
| **termux-am** | 0.8.1 | Android Oreo-compatible am command reimplementation | https://github.com/termux/TermuxAm |
...
| **termux-api** | 0.60.0 | Termux API commands (install also the Termux:API app) | https://wiki.termux.com/wiki/Termux:API |
| **termux-api-static** | 0.60.0 | Static libraries for termux-api | https://wiki.termux.com/wiki/Termux:API |
...
| **texlive-bin** | 1:2026.0-2 | TeX Live is a distribution of the TeX typesetting system. This package contains architecture dependent binaries. | https://www.tug.org/texlive/ |
| **texlive-bin-static** | 1:2026.0-2 | Static libraries for texlive-bin | https://www.tug.org/texlive/ |
| **texlive-installer** | 20260301 | Wrapper around texlive's install-tl script | https://www.tug.org/texlive/ |
| **tgpt** | 2.15.0 | AI Chatbots in terminal without needing API keys | https://github.com/aandrew-me/tgpt |
...
| **tinygo** | 0.42.0-1 | Go compiler for microcontrollers, WASM, CLI tools | https://tinygo.org |
| **tinygo-common** | 0.42.0-1 | TinyGo common files | https://tinygo.org |
| **tinymist** | 0.15.8 | An integrated language service for Typst | https://myriad-dreamin.github.io/tinymist |
...
| **tree-sitter** | 0.27.0 | An incremental parsing system for programming tools | https://tree-sitter.github.io/ |
| **tree-sitter-bash** | 0.25.1-2 | Bash grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-bash |
| **tree-sitter-c** | 0.24.2-1 | C grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-c |
| **tree-sitter-css** | 0.25.0-2 | CSS grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-css |
| **tree-sitter-go** | 0.25.0-2 | Golang grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-go |
| **tree-sitter-html** | 0.23.2-2 | HTML grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-html |
| **tree-sitter-java** | 0.23.5-2 | Java grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-java |
| **tree-sitter-javascript** | 0.25.0-2 | JavaScript grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-javascript |
| **tree-sitter-json** | 0.24.8-2 | JSON grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-json |
| **tree-sitter-latex** | 0.6.0-2 | LaTeX grammar for tree-sitter | https://github.com/latex-lsp/tree-sitter-latex |
| **tree-sitter-lua** | 0.5.0-2 | Lua grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-lua |
| **tree-sitter-markdown** | 0.5.3-2 | Markdown grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
| **tree-sitter-parsers** | 0.27 | A metapackage that provides commonly used treesitter parsers | https://github.com/termux/termux-packages |
| **tree-sitter-python** | 0.25.0-2 | Python grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-python |
| **tree-sitter-query** | 0.8.0-3 | TS query grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-query |
| **tree-sitter-regex** | 0.25.0-2 | RegEx grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-regex |
| **tree-sitter-rust** | 0.24.2-2 | Rust grammar for tree-sitter | https://github.com/tree-sitter/tree-sitter-rust |
| **tree-sitter-sql** | 0.3.11-2 | SQL grammar for tree-sitter | https://github.com/derekstride/tree-sitter-sql |
| **tree-sitter-toml** | 0.7.0-2 | TOML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-toml |
| **tree-sitter-vim** | 0.8.1-2 | Vimscript grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-vim |
| **tree-sitter-vimdoc** | 4.1.0-3 | Tree-sitter parser for Vim help files | https://github.com/neovim/tree-sitter-vimdoc |
| **tree-sitter-xml** | 0.7.0-2 | XML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-xml |
| **tree-sitter-yaml** | 0.7.2-2 | YAML grammar for tree-sitter | https://github.com/tree-sitter-grammars/tree-sitter-yaml |
...
| **tsduck-java** | 3.45.4798 | Java bindings for TSDuck | https://tsduck.io/ |
| **tsduck-plugins** | 3.45.4798 | Plugins for TSDuck | https://tsduck.io/ |
| **tsduck-python** | 3.45.4798 | Python bindings for TSDuck | https://tsduck.io/ |
| **tsduck-tools** | 3.45.4798 | Command line tools for TSDuck | https://tsduck.io/ |
...
| **txr** | 302 | Data munging language and pattern matching tool | https://www.nongnu.org/txr/ |
| **ty** | 0.0.84 | An extremely fast Python type checker and language server, written in Rust | https://github.com/astral-sh/ty |
...
| **unrar** | 7.3.1 | Tool for extracting files from .rar archives | https://www.rarlab.com/ |
...
| **usql** | 0.21.6 | A universal command-line interface for SQL databases | https://github.com/xo/usql |
| **utf8cpp** | 1:4.2.1 | UTF8-CPP: UTF-8 with C++ in a Portable Way | https://github.com/nemtrif/utfcpp |
| **utf8proc** | 2.12.0 | Library for processing UTF-8 Unicode data | https://github.com/JuliaLang/utf8proc |
| **utf8proc-static** | 2.12.0 | Static libraries for utf8proc | https://github.com/JuliaLang/utf8proc |
...
| **uv** | 0.12.19 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vulkan-loader-android** | 30 | Vulkan Loader for Android | https://source.android.com/devices/graphics/arch-vulkan |
| **vulkan-loader-generic** | 1.4.364 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.364 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.364 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **wabt** | 1.0.42 | The WebAssembly Binary Toolkit | https://github.com/WebAssembly/wabt |
| **wakatime-cli** | 2.26.11 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **wget2** | 2.3.0 | The successor of GNU Wget, a file and recursive website downloader | https://gitlab.com/gnuwget/wget2 |
| **wget2-static** | 2.3.0 | Static libraries for wget2 | https://gitlab.com/gnuwget/wget2 |
...
| **xsimd** | 14.3.0-1 | C++ wrappers for SIMD intrinsics | https://github.com/xtensor-stack/xsimd |
...
| **xxhash** | 0.8.4 | Extremely fast non-cryptographic hash algorithm | https://cyan4973.github.io/xxHash/ |
| **xxhash-static** | 0.8.4 | Static libraries for xxhash | https://cyan4973.github.io/xxHash/ |
...
| **zellij** | 0.45.1 | A terminal workspace with batteries included | https://zellij.dev/ |
