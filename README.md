...
| **dasel** | 3.3.2 | Select, put and delete data from JSON, TOML, YAML, XML and CSV files with a single utility | https://github.com/TomWright/dasel |
...
| **harfbuzz** | 13.2.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 13.2.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 13.2.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **neovim-nightly** | 0.12.0~dev-2610+gc3308fa5fe-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
...
| **step-cli** | 0.30.0 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **turbo** | 2.8.19 | High-performance build system for JS/TS | https://turbo.build/ |
...
| **uv** | 0.10.11 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vim** | 9.2.0192 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **xxd** | 9.2.0192 | Hexdump utility from vim | https://www.vim.org |
