...
| **govulncheck** | 1.7.0 | Reports known vulnerabilities affecting Go code | https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck |
...
| **lazygit** | 0.65.0 | Simple terminal UI for git commands | https://github.com/jesseduffield/lazygit |
...
| **libsecret** | 0.21.8 | A GObject-based library for accessing the Secret Service API | https://gitlab.gnome.org/GNOME/libsecret |
...
| **lux-cli** | 0.43.5 | A package manager for Lua, similar to luarocks | https://lux.lumen-labs.org |
...
| **neovim-nightly** | 0.13.0~dev-1596+g28ff47b8a4-0 | Ambitious Vim-fork focused on extensibility and agility (nvim-nightly) | https://neovim.io/ |
