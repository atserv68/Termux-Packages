...
| **gh** | 2.99.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **python-ruff** | 0.16.5 | An extremely fast Python linter, written in Rust (Python bindings) | https://github.com/charliermarsh/ruff |
...
| **ruff** | 0.16.5 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **simdjson** | 4.6.9 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
